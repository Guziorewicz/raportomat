                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="<?php echo e(route('raporty.index')); ?>">Lista raportów</a></li></div>
                            </div>
...
<?php /**PATH /var/www/laravel/projekt/raportomat/resources/views/welcome.blade.php ENDPATH**/ ?>